...
export default (props) => {
    let { paginationSize, loading, searchText, tableHeader, tableData, editUrl, showModal } = props;
          ...
          <span>
            ...
            <Tooltip title="Delete">
              <Button
                ...
                danger
                shape="circle"
                onClick={() => (showModal ? showModal(row.id) : null)}
              >
    ...
    return (
        <>
            <Table
                ...
                pagination={{
                    size: "medium",
                    pageSize: paginationSize ? paginationSize : 20,

...
export const Follower = 'Total Products';
export const Following = 'SOold Products';
...
export const UsersTableTitle = 'Add User';
...
//Shops
export const ShopsTableTitle = 'Add Shops';
export const ShopsTableHeader = [
  'ShopName',
  'Description',
  ' Type',
  'Address1',
...
//Orders
export const OrdersTableTitle = 'Orders';
...
//Vendors
export const VendorsTableTitle = 'All Vendors';
...
//Coupons
export const CouponsTableTitle = 'Issued Coupons';
export const CouponsTableHeader = [
  'Coupon Type',
  'Coupon Code',
  'Price (Min-Max)',
  'Date (Start-End)',
...
//Payment
export const CompletedTransactionTableTitle = ' Payment Status ';
export const CompletedTransactionTableHeader = [
  'Name',
  'Address',
  'Product Id',
  'Payment Status',
...
// Reviews
export const ReviewsTableTitle = 'Customer Review';
export const ReviewsTableHeader = [
  'Product Name',
  'Total Reviews',
  'Total Rating',
  'Average Rating',
...
// Support
export const SupportTableTitle = 'Support';
...
export const AppConfigTableHeader = ['Name', 'Value'];

// Plans
export const PlansTableHeader = [
  "Member's Name",
  'Address',
  'Email Address',
  'Subscribtion Type',
...
// Roles
export const RolesTableTitle = 'Roles';
export const RolesTableHeader = ["Role's Name", 'Type', 'Action'];
// Category
export const CategoryTableTitle = 'Category';
...
// Category
export const ColorsTableTitle = 'Color';
export const ColorsTableHeader = ['Color Name', 'Color Code'];

// Variant
export const VariantTableTitle = 'Variant';
export const VariantTableHeader = ['Variant Name', 'Description'];

// Variant
export const DealTableHeader = [
  'Deals Name',
  'Description',
  'Daily Featured',
  'Set Date',
...
export const DealTableTitle = 'Deal';

// Brands
export const BrandsTableTitle = 'Brands';
export const BrandsTableHeader = ['Brand Name'];

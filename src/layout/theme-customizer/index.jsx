...
import {
  ...
  ModalBody,
  ModalFooter, ModalHeader, Row, TabContent,
  TabPane
} from 'reactstrap';
import {
  Apply, Border, Box, Cancel, Configuration,
  ...
  FadeBottom, IconColor, LayoutType,
  LTR,
  ...
  None, RouterAnimation, RTL,


  SidebarSettings, SidebarType,
...
import {
  ADD_COLOR,
  ADD_COSTOMIZER, ADD_LAYOUT,




  ADD_MIX_BACKGROUND_LAYOUT, ADD_SIDEBAR_SETTINGS, ADD_SIDEBAR_TYPES,

    ...
    <Fragment>
      <div className="sidebar-wrapper">
        <div className="logo-wrapper dashboard-logo">
          ...
          <div
            className="toggle-sidebar toggle-icon"
                ...
                <Fragment key={i}>
                  {Item.Items.map((menuItem, i) => (
                    <li className="sidebar-list" key={i}>
                      {menuItem.type === 'sub' ? (
                        <a
                          className={`sidebar-link sidebar-title  ${location.pathname === menuItem.path ? 'active' : ''
                            }`}
                          href="#"
                      ...
                      {menuItem.type === 'link' ? (
                        <Link
                          to={menuItem.path}
                          className={`sidebar-link sidebar-title link-nav  ${location.pathname === menuItem.path ? 'active' : ''
                            }`}
                          href="#"
                            ...
                            return (
                              <li key={index}>
                                {childrenItem.type === 'sub' ? (
                                  <a
                                    className={`${location.pathname === childrenItem.path? 'active' : ''
                                      }`}
                                    href="#"
                                    onClick={() =>
                                        ...
                                        <li key={key}>
                                          {childrenSubItem.type === 'link' ? (
                                            <Link
                                              ...
                                              className={`${location.pathname === childrenSubItem.path 
                                                  ? 'active'
                                                  : ''
                                                }`}
                                              onClick={() =>

...
import { ADMINMENUITEMS } from '../sidebar/adminMenu';
import { VENDORMENUITEMS } from '../sidebar/vendorMenu';
...
const Header = (props) => {
  ...
  if (auth?.currentUser?.role === 2 || auth?.currentUser?.role === 1) {
    MENUITEMS = ADMINMENUITEMS;
  } else if (auth?.currentUser?.role === 3) {
  ...
  return (
    <Fragment>
      <div className="page-header">
        <Row className="header-wrapper m-0 d-flex w-100 justify-content-end">

...
export default class AddVariantOptions extends Component {
    state = {
        inputVisible: false,
        inputValue: '',
        editInputIndex: -1,
    ...
    handleInputConfirm = () => {
        ...
        if (inputValue && this.props.options.indexOf(inputValue) === -1) {  // input value doesnot exist in array 
    ...
    handleEditInputChange = e => this.setState({ editInputValue: e.target.value });

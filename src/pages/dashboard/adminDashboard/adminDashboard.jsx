    ...
    <Fragment>
      ...
      <Container fluid={true}>
        <Row className="size-column">
          ...
          <Col xl="4 xl-50" className="box-col-12"></Col>
                    ...
                    <div className="goal-end-point">
                      <ul>
                        ...
                        <li>
                          ...
                          <h5 className="mb-0">{'Rs 94,000.20'}</h5>
                        </li>
                      </ul>
                    </div>
                  </div>
                          ...
                          <Table borderless>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  {' '}
                                  <span className="label">{'Rs 5,08,652'}</span>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  {' '}
                                  <span className="label">{'Rs 59,105'}</span>
                                </td>
                                <td className="text-right">
                                  <i className="fa fa-check-circle"></i>
                                  {Pending}
                              ...
                              <tr>
                                ...
                                <td>
                                  {' '}
                                  <span className="label">{'Rs 10,155'}</span>
                                </td>
                                <td className="text-right">
                                  <i className="fa fa-check-circle"></i>
                                  {Success}
                              ...
                              <tr>
                                ...
                                <td>
                                  {' '}
                                  <span className="label">{'Rs 90,568'}</span>
                                </td>
                                <td className="text-right">
                                  {' '}
                                  <i className="fa fa-check-circle"></i>
                              ...
                              <tr>
                                ...
                                <td>
                                  {' '}
                                  <span className="label">{'Rs 10,652'}</span>
                                </td>
                                <td className="text-right">
                                  <i className="fa fa-check-circle"></i>
                                  {Pending}
